...
public interface IRegistarUtilizadorHandler {
	...
	/**
	 * Regista um utilizador Funcionario. Esse funcionario soh poderah fazer
	 * login durante o seu turno.
	 * 
	 * @param u
	 *            - Username do utilizador
	 * @param p
	 *            - Password do utilizador
	 * @param st
	 *            - Hora de entrada do funcionario
	 * @param st
	 *            - Hora de saida do funcionario
