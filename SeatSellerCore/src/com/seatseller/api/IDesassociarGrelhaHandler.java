...
/**
 * Handler do Caso de Uso UC10 - Desassociar grelha Este handler soh estarah
...
public interface IDesassociarGrelhaHandler {
	 ...
	 * 
	 * @param desig
	 *            - Designacao da grelha a desassociar
	 * @param c
	 *            - O receiver das notificacoes que foram enviadas ao
