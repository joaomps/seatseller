...
public interface IReservarLugarHandler {
	 ...
	 *             - se um cliente com o nome nCli nao existir
	 * @requires cCli != null
	 */
	 ...
	 * @param time
	 *            - Hora da reserva
	 * @return lista de objetos contendo informacao sobre lugares disponiveis
	 *         para a data-hora indicadas.
	...
	/**
	 * @param grelha
	 *            - Qual a grelha que se pretende reservar
	 * @param tipoDeLugar
	 *            - Qual o tipo de lugar que se pretende reservar
	 * @return a identificacao (linha, coluna) do lugar a reservar
	 * @throws DoesNotExistException
	 *             se uma grelha com a designacao indicada nao existir ou um
	 *             tipo de lugar com a designacao indicada nao existir
	 */
	String indicarCombinacao(String grelha, String tipoDeLugar)
			throws DoesNotExistException;

	/**
	 * Indicar que nao se pretende reservar mais lugares para a data-hora
	 ...
	 * @param ccv
	 *            - ccv2 do cartao de credito
	 * @param mes
	 *            - mes da data de validade do cartao de credito
	 * @param ano
	 *            - mes da data de validade do cartao de credito
	 * @throws InvalidCreditCardException
	 *             - se o cartao de credito com os dados indicados nao eh valido
	 */
	double indicarCC(String num, int ccv, int mes, int ano)
			throws InvalidCreditCardException;
