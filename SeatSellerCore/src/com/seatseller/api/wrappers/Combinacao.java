...
/**
 * Classe wrapper que "embrulha" 4 tipos de informacao sobre a disponibildade de
 * lugares em grelhas
 */
public class Combinacao {
	 ...
	 * 
	 * @param grelha
	 *            - a designacao da grelha
	 * @param tipo
	 *            - o tipo de lugar disponivel
	 * @param p
	 *            - o preco desse tipo de lugar
	...
	public String toString() {
		return this.getGrelha() + " | " + this.getTipoDeLugar() + " | "
				+ this.getPreco() + " € | " + this.getDisponibilidade()
				+ " livres";
	}
}
